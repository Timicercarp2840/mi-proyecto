...
class EvaluacionController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.modulos')->with('success', 'Evaluación creada exitosamente.');
    }
    ...
    public function update(Request $request, $id_eval)
    {
        ...
        return redirect()->route('admin.modulos')->with('success', 'Evaluación actualizada exitosamente.');
    }
    ...
    public function destroy($id_eval)
    {
        ...
        return redirect()->route('admin.modulos')->with('success', 'Evaluación eliminada exitosamente.');
    }
