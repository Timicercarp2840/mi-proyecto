            ...
            <div class="container mx-auto px-4 py-8">                <!-- Header -->
                <div class="text-center mb-8">
                    <h1 class="text-4xl font-bold mb-4 text-purple-300">
                        📁 Maestro del Sistema de Archivos - {{ nivel || 'Básico' }}
                    </h1>
                ...
                <div class="flex justify-center mb-8">
                    <div class="bg-gray-800 rounded-lg p-4 border border-purple-500">
                        <div class="flex space-x-4">
                            <Link 
                                :href="route('desafios.filesystem', 'basico')"
                                class="px-4 py-2 rounded-lg transition-colors"
                                :class="(nivel || 'Básico') === 'Basico' ? 'bg-purple-600 text-white' : 'bg-gray-700 text-purple-300 hover:bg-gray-600'"
                            >
                                🟢 Básico
                            </Link>
                            <Link 
                                :href="route('desafios.filesystem', 'intermedio')"
                                class="px-4 py-2 rounded-lg transition-colors"
                                :class="(nivel || 'Básico') === 'Intermedio' ? 'bg-purple-600 text-white' : 'bg-gray-700 text-purple-300 hover:bg-gray-600'"
                            >
                                🟡 Intermedio
                            </Link>
                            <Link 
                                :href="route('desafios.filesystem', 'avanzado')"
                                class="px-4 py-2 rounded-lg transition-colors"
                                :class="(nivel || 'Básico') === 'Avanzado' ? 'bg-purple-600 text-white' : 'bg-gray-700 text-purple-300 hover:bg-gray-600'"
                            >
                                🔴 Avanzado
                            </Link>
                        </div>
