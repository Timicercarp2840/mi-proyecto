<template>
    <AuthenticatedLayout>
        <div class="bg-gradient-to-br from-gray-900 via-green-900 to-black min-h-screen text-green-400">            <div class="container mx-auto px-4 py-8">
                <!-- Header -->
                <div class="text-center mb-8">
                    <h1 class="text-4xl font-bold mb-4 text-green-300">
                        🖥️ Terminal Interactivo - {{ nivel }}
                    </h1>
                    <p class="text-lg text-green-200">
                        Domina los comandos de Linux y gana XP
                    </p>
                </div>
                ...
                <div class="flex justify-center mb-8">
                    <div class="bg-gray-800 rounded-lg p-4 border border-green-500">
                        <div class="flex space-x-4">
                            <Link 
                                :href="route('desafios.terminal', 'basico')"
                                class="px-4 py-2 rounded-lg transition-colors"
                                :class="nivel === 'Basico' ? 'bg-green-600 text-white' : 'bg-gray-700 text-green-300 hover:bg-gray-600'"
                            >
                                🟢 Básico
                            </Link>
                            <Link 
                                :href="route('desafios.terminal', 'intermedio')"
                                class="px-4 py-2 rounded-lg transition-colors"
                                :class="nivel === 'Intermedio' ? 'bg-yellow-600 text-white' : 'bg-gray-700 text-green-300 hover:bg-gray-600'"
                            >
                                🟡 Intermedio
                            </Link>
                            <Link 
                                :href="route('desafios.terminal', 'avanzado')"
                                class="px-4 py-2 rounded-lg transition-colors"
                                :class="nivel === 'Avanzado' ? 'bg-red-600 text-white' : 'bg-gray-700 text-green-300 hover:bg-gray-600'"
                            >
                                🔴 Avanzado
                            </Link>
                        </div>
