                        ...
                        <form @submit.prevent="submit">
                            <div class="grid grid-cols-1 gap-6">
                                ...
                                <div class="flex items-center justify-end space-x-4 pt-6 border-t">
                                    ...
                                    >
                                        {{ form.processing ? 'Actualizando...' : 'Actualizar Evaluación' }}
                                    </button>
                                </div>
                            </div>
                        </form>
...
const form = useForm({
    id_modulo: props.evaluacion.id_modulo,
    contenido_eval: JSON.parse(JSON.stringify(props.evaluacion.contenido_eval || [])),
});
...
const submit = () => {
    form.put(route('admin.evaluaciones.update', props.evaluacion.id_eval));
};
</script>
